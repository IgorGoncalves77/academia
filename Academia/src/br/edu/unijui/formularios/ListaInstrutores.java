...
public class ListaInstrutores extends javax.swing.JFrame {

    static private ResultSetTableModel tableModel;

    public ListaInstrutores() throws SQLException, ClassNotFoundException {
        ...
        InstrutoresImpl instrutoresImpl = new InstrutoresImpl(); 
            ResultSet rs = instrutoresImpl.listarInstrutores2();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de Instrutores");
        jLabel2.setAlignmentY(0.0F);
        jLabel2.setFocusable(false);

        jButton2.setText("Adicionar Instrutor");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        frmInstrutores frame = new frmInstrutores();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaInstrutores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ListaInstrutores().setVisible(true);

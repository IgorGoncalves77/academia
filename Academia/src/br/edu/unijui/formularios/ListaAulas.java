...
public class ListaAulas extends javax.swing.JFrame {
    ...
    public ListaAulas() throws SQLException, ClassNotFoundException {
        ...
        AulasImpl aulasImpl = new AulasImpl(); 
            ResultSet rs = aulasImpl.listarAulas2();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Adicionar Aula");
        ...
        jLabel2.setText("Lista de Aulas");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ListaAulas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaAulas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ListaAulas().setVisible(true);

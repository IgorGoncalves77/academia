...
public class ListaPlanos extends javax.swing.JFrame {
    ...
    public ListaPlanos() throws SQLException, ClassNotFoundException {
       
        //define os nomes das colunas da tabela 
        String[] colunas = new String[]{"Nome","Duração (Semanas)", "Preço"};
        tableModel = new ResultSetTableModel(colunas);
        
        PlanosImpl planosImpl = new PlanosImpl(); 
            ResultSet rs = planosImpl.listarPlanos2();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de Planos");
        jLabel2.setAlignmentY(0.0F);
        jLabel2.setFocusable(false);

        jButton2.setText("Adicionar Plano");
